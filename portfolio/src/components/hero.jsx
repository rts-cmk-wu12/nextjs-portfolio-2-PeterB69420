        ...
        <section className="flex flex-col md:flex-row items-center justify-center text-center md:text-left">
            <div className="max-w-5xl mx-auto px-6 pl-25 py-10 md:py-20 flex flex-col md:flex-row items-center">
                <div className="md:w-1/2">
                    <h1 className=" text-heading text-5xl font-bold mb-4">Jonas</h1>
                    <p className=" mb-6">
                    ...
                    <Link className="bg-[#62BA1B] hover:bg-[#3F8E00] text-heading font-bold px-7 py-4 rounded shadow-lg shadow-lime-500/20 transition-all duration-300 cursor-pointer" href="/contact" style={{ width: '259.89px', display: 'inline-block', textAlign: 'center' }}>
                        Get in touch &gt;
                    </Link>
                </div>
